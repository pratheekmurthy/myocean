...
exports.fetchSignUp = async (req, res, next) => {
  try {
    ...
    query +=
      " on user1.mailing_add_country_fk = mailingcompany.country_mst_pk ";
    query += " where 1 = 1 ";
    ...
    query +=
      " left join (select * from qport_user_notify n where n.userfk = " +
      userpk +
      ") usr ";
    ...
    query += " from qport_dropdown_values qdv ";
    query +=
      " left join (select * from qport_user_alerts n where n.userfk = " +
      userpk +
      ") usr ";
...
exports.validateEmail = async (req, res, next) => {
  try {
    ...
    if (data == 0) {
      res
        .status(200)
        .json({ Status: "Success", StatusCode: "GFE000001", Data: email });
    } else {
      res
        .status(200)
        .json({ Status: "Error", StatusCode: "GFE000009", Data: email });
    }
  } catch (err) {
    if (!err.statusCode) {
      err.statusCode = 500;
...
exports.validateMobile = async (req, res, next) => {
  try {
    ...
    if (data == 0) {
      res
        .status(200)
        .json({ Status: "Success", StatusCode: "GFE000001", Data: mobile });
    } else {
      res
        .status(200)
        .json({ Status: "Error", StatusCode: "GFE000009", Data: mobile });
    }
  } catch (err) {
    if (!err.statusCode) {
      err.statusCode = 500;
...
exports.inviteColleague = async (req, res, next) => {
  try {
    const companyName = process.env.companyName || "Carpenter Shipping";
    const { Emailids, UserName } = req.body;
    const reciverList = Emailids.split(",");
    const subject = "Invitation to Join MyOcean";
    ...
    <p style="box - sizing: border - box; cursor: text; font - family: 'Exo 2', sans - serif!important; white - space: pre - wrap; word - spacing: 0px; text - transform: none; font - weight: 400; color: #567c87; font-style: normal; text-align: left; orphans: 2; widows: 2; margin: 0px; letter-spacing: normal; counter-reset: list-1 0 list-2 0 list-3 0 list-4 0 list-5 0 list-6 0 list-7 0 list-8 0 list-9 0; line-height: 19px; background-color: #fefefe; text-indent: 0px; font-variant-ligatures: normal; font-variant-caps: normal; -webkit-text-stroke-width: 0px; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; padding: 0px; text-align: justify;"><span style="font-size: small;"> ${companyName} looks forward to partnering with you, and being part of your success</span></p>
    <p style="box - sizing: border - box; cursor: text; font - family: 'Exo 2', sans - serif!important; white - space: pre - wrap; word - spacing: 0px; text - transform: none; font - weight: 400; color: #567c87; font-style: normal; text-align: left; orphans: 2; widows: 2; margin: 0px; letter-spacing: normal; counter-reset: list-1 0 list-2 0 list-3 0 list-4 0 list-5 0 list-6 0 list-7 0 list-8 0 list-9 0; line-height: 19px; background-color: #fefefe; text-indent: 0px; font-variant-ligatures: normal; font-variant-caps: normal; -webkit-text-stroke-width: 0px; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; padding: 0px; text-align: justify;"><span style="font-size: small;"> &nbsp;</p>
    ...
    <p style="box - sizing: border - box; cursor: text; font - family: 'Exo 2', sans - serif!important; white - space: pre - wrap; word - spacing: 0px; text - transform: none; font - weight: 400; color: #567c87; font-style: normal; text-align: left; orphans: 2; widows: 2; margin: 0px; letter-spacing: normal; counter-reset: list-1 0 list-2 0 list-3 0 list-4 0 list-5 0 list-6 0 list-7 0 list-8 0 list-9 0; line-height: 19px; background-color: #fefefe; text-indent: 0px; font-variant-ligatures: normal; font-variant-caps: normal; -webkit-text-stroke-width: 0px; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; padding: 0px; text-align: justify;"><span style="font-size: small;"> ${companyName} </span ></p>`;

    let response = await sendEmails(
      emailerInfo.FromUser,
      reciverList,
      output,
      subject
    );
    if (response.status) {
      res
        .status(200)
        .json({ Status: "Success", StatusCode: "GFS000001", PKValue: 1 });
    }
  } catch (err) {
    if (!err.statusCode) {
      err.statusCode = 500;
    ...
    return new Promise(async (resolve, reject) => {
      ...
      if (data.userpk == 0) {
        ...
        query +=
          ...
          chkIsNull(data.contact_bus_countrycode) +
          "', ";
        query +=
          " contact_bus_area='" + chkIsNull(data.contact_bus_area) + "', ";
        query +=
          " contact_bus_tel_no='" + chkIsNull(data.contact_bus_tel_no) + "', ";
        query +=
          " contact_mob_countrycode='" +
          chkIsNull(data.contact_mob_countrycode) +
          "', ";
        query +=
          " contact_mob_phone_no='" +
          chkIsNull(data.contact_mob_phone_no) +
          "', ";
        query +=
        ...
        query +=
          ...
          chkIsNull(data.mailing_add_str_add1) +
          "', ";
        query +=
          " mailing_add_str_add2='" +
          chkIsNull(data.mailing_add_str_add2) +
          "', ";
        query +=
          " mailing_add_city='" + chkIsNull(data.mailing_add_city) + "', ";
        query +=
          " mailing_add_state='" + chkIsNull(data.mailing_add_state) + "', ";
        query +=
          " mailing_add_country_fk=" +
          chkIsNull(data.mailing_add_country_fk) +
          ", ";
        query +=
          " mailing_add_zipcode='" +
          chkIsNull(data.mailing_add_zipcode) +
          "', ";
        query +=
          " login_password='" + chkIsNull(data.login_password, "") + "', ";
        query +=
          " login_confirm_password='" +
          chkIsNull(data.login_confirm_password) +
          "', ";
        ...
        query +=
          ...
          "', ";
        query +=
          " wrong_pwd_count=" + chkIsNull(data.wrong_pwd_count, 0) + ", ";
        ...
        query +=
          ...
          chkIsNull(data.copy_mailing_address) +
          "', ";
  ...
  return new Promise(async (resolve, reject) => {
    ...
    for (let i = 0; i < data.length; i++) {
      if (data[i].usernotifypk == undefined || data[i].usernotifypk == 0) {
        ...
        query +=
          " last_updated_by_fk=" + chkIsNull(data[i].created_by_fk, 1) + ",";
        query += " last_updated_on= sysdate,";
        query += " version_no= version_no + 1 ";
